...
const faqs = [
  {
    question: 'Как быстро происходит обмен USDT в Ярославле?',
    answer: 'Срочный обмен USDT занимает около 5 минут с момента встречи в офисе криптообмена. Мгновенный перевод USDT может задержаться из-за загруженности сети блокчейна.',
  },
  {
    question: 'Почему курс USDT меняется и как он фиксируется?',
    answer: 'Курс доллара USDT зависит от рыночных колебаний. Выгодный курс обмена фиксируется при подтверждении заявки менеджером и не изменяется до завершения сделки.',
  },
  {
    question: 'Какие криптовалюты можно обменять кроме USDT?',
    answer: 'Обмен биткоина Ярославль, обмен эфириума Ярославль, USDC. Лучший курс обмена уточняйте в нашем Telegram-канале.',
  },
  {
    question: 'Какая минимальная сумма для обмена криптовалют?',
    answer: 'Минимальная сумма для обмена USDT наличные составляет 50,000 рублей или эквивалент в USDT для встречи в офисе обмена USDT и курьерской доставки.',
  },
  {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Как выгодно продать USDT - Частые вопросы
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Как вывести USDT в рубли наличными? Ответы на вопросы о безопасном обмене криптовалюты в Ярославле
          </p>
        </div>
